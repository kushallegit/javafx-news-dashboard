...
public class NewsView {
    ...
    private VBox createArticleBox(NewsArticle article) {
        ...
        articleBox.getStyleClass().add("article-card");
        ...
        urlLabel.getStyleClass().add("read-more"); // ✅ Apply style class
        ...
        if (imageUrl != null && !imageUrl.isEmpty()) {
            try {
                ...
                imageView.getStyleClass().add("news-image"); // ✅ Apply style class here
